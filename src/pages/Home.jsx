...
const Home = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    localStorage.setItem("adminuser",response.data.Data.user);
          ...
          <div className="left">
            <form className="form">
              ...
              <div className="input-block">
                ...
                />
                <label htmlFor="email" className="admin-label">Username</label>
              </div>
              ...
              <div className="input-block">
                <input
                  ...
                  onChange={handleInput}
                />
                <label htmlFor="pass" className="admin-label">Password</label>
              </div>
